...
pca.input.x <- input$data.frame$RightFoot.Dx
pca.input.z <- input$data.frame$RightFoot.Dz

pca.ref.x <- ref$data.frame$RightFoot.Dx
pca.ref.z <- ref$data.frame$RightFoot.Dz
...
input.dx <- input$data.frame$RightFoot.Dx
input.dz <- input$data.frame$RightFoot.Dz

ref.dx <- ref$data.frame$RightFoot.Dx
ref.dz <- ref$data.frame$RightFoot.Dz
...
ll1 <- list()
ml1 <- matrix(rep(0, 2 * length(list.right.input)), nrow = length(list.right.input), ncol = 2)
for (a in 1:length(list.right.input))
{
  coord <- list.right.input[[a]]
...
ll2 <- list()
ml2 <- matrix(rep(0, 2 * length(list.right.ref)), nrow = length(list.right.ref), ncol = 2)
for (a in 1:length(list.right.ref))
{
  coord <- list.right.ref[[a]]
...
{
  coord.in <- list.right.input[[my.dtw$index1[a]]]
  coord.ref <- list.right.ref[[my.dtw$index2[a]]]
